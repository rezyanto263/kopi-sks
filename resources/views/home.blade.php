...
{{-- Hero Section --}}
<section id="hero-section" class="z-5 bg-gradient-to-br from-[#963C00] via-[#7d3200] to-[#5e2400] text-white py-24 opacity-0 translate-y-10 transition-all duration-1000 rounded-b-[3rem] shadow-xl">
...
{{-- Produk Section --}}
<section id="products"
         class="z-5 py-24 bg-white text-[#963C00] opacity-0 translate-y-10 transition-all duration-1000 delay-300"
         data-scroll-section>
