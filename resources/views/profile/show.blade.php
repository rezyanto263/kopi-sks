...
@section('content')
    ...
    <div class="relative z-10 w-full max-w-4xl mx-auto px-6 py-20">
        <div class="bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white rounded-3xl shadow-2xl p-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div>
                <form id="profile-form" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <!-- Upload Foto  -->
                    <div>
                        <label for="profile_photo" class="block mb-2 text-sm font-medium text-yellow-100">Ubah Foto Profil</label>
